...
// Internal CMS compatibility slab extracted from the legacy client surface.
export interface LegacyCmsApi {
  getCmsSummary: (...args: any[]) => Promise<any>
  getIamSummary: (...args: any[]) => Promise<any>
  listCmsSpaces: (...args: any[]) => Promise<any>
  createCmsSpace: (...args: any[]) => Promise<any>
  updateCmsSpace: (...args: any[]) => Promise<any>
  listCmsContentTypes: (...args: any[]) => Promise<any>
  listCmsSchemas: (...args: any[]) => Promise<any>
  createCmsSchema: (...args: any[]) => Promise<any>
  getCmsSchema: (...args: any[]) => Promise<any>
  updateCmsSchema: (...args: any[]) => Promise<any>
  listCmsSchemaVersions: (...args: any[]) => Promise<any>
  listCmsTenantBindings: (...args: any[]) => Promise<any>
  updateCmsTenantBinding: (...args: any[]) => Promise<any>
  listCmsValidationDomains: (...args: any[]) => Promise<any>
  listCmsEntries: (...args: any[]) => Promise<any>
  createCmsEntry: (...args: any[]) => Promise<any>
  getCmsEntry: (...args: any[]) => Promise<any>
  updateCmsEntryDraft: (...args: any[]) => Promise<any>
  publishCmsEntry: (...args: any[]) => Promise<any>
  archiveCmsEntry: (...args: any[]) => Promise<any>
  listCmsEntryRevisions: (...args: any[]) => Promise<any>
  restoreCmsEntryRevision: (...args: any[]) => Promise<any>
  listCmsWorkflows: (...args: any[]) => Promise<any>
  getCmsWorkflow: (...args: any[]) => Promise<any>
  submitCmsWorkflow: (...args: any[]) => Promise<any>
  requestCmsWorkflowChanges: (...args: any[]) => Promise<any>
  approveCmsWorkflow: (...args: any[]) => Promise<any>
  listCmsPreviewSessions: (...args: any[]) => Promise<any>
  createCmsPreviewSession: (...args: any[]) => Promise<any>
  getCmsPreviewSession: (...args: any[]) => Promise<any>
  listCmsReleases: (...args: any[]) => Promise<any>
  createCmsRelease: (...args: any[]) => Promise<any>
  getCmsRelease: (...args: any[]) => Promise<any>
  publishCmsRelease: (...args: any[]) => Promise<any>
  rollbackCmsRelease: (...args: any[]) => Promise<any>
  listCmsMediaFolders: (...args: any[]) => Promise<any>
  createCmsMediaFolder: (...args: any[]) => Promise<any>
  listCmsMediaAssets: (...args: any[]) => Promise<any>
  createCmsMediaAsset: (...args: any[]) => Promise<any>
  getCmsMediaAsset: (...args: any[]) => Promise<any>
  updateCmsMediaAsset: (...args: any[]) => Promise<any>
  listCmsMediaRenditions: (...args: any[]) => Promise<any>
  getCmsMediaRendition: (...args: any[]) => Promise<any>
  listCmsDeliveryContent: (...args: any[]) => Promise<any>
  getCmsDeliveryContent: (...args: any[]) => Promise<any>
  resolveCmsDeliveryPath: (...args: any[]) => Promise<any>
  getCmsPreviewDelivery: (...args: any[]) => Promise<any>
  queryCms: (...args: any[]) => Promise<any>
  listCmsLocalizationEntries: (...args: any[]) => Promise<any>
  getCmsLocalizationEntry: (...args: any[]) => Promise<any>
  upsertCmsLocaleBranch: (...args: any[]) => Promise<any>
  getCmsGraphqlSchema: (...args: any[]) => Promise<any>
  executeCmsGraphql: (...args: any[]) => Promise<any>
  listCmsBlueprints: (...args: any[]) => Promise<any>
  createCmsBlueprint: (...args: any[]) => Promise<any>
  listCmsBlueprintInstallations: (...args: any[]) => Promise<any>
  installCmsBlueprint: (...args: any[]) => Promise<any>
  getCmsAccessSummary: (...args: any[]) => Promise<any>
  listCmsRoles: (...args: any[]) => Promise<any>
  createCmsRole: (...args: any[]) => Promise<any>
  updateCmsRole: (...args: any[]) => Promise<any>
  listCmsRoleAssignments: (...args: any[]) => Promise<any>
  createCmsRoleAssignment: (...args: any[]) => Promise<any>
  updateCmsRoleAssignment: (...args: any[]) => Promise<any>
  listCmsApiTokens: (...args: any[]) => Promise<any>
  createCmsApiToken: (...args: any[]) => Promise<any>
  updateCmsApiToken: (...args: any[]) => Promise<any>
  getCmsVisualAuthoringSummary: (...args: any[]) => Promise<any>
  listCmsExperienceBindings: (...args: any[]) => Promise<any>
  listCmsVisualAuthoringSessions: (...args: any[]) => Promise<any>
  createCmsVisualAuthoringSession: (...args: any[]) => Promise<any>
  getCmsVisualAuthoringSession: (...args: any[]) => Promise<any>
  updateCmsVisualBinding: (...args: any[]) => Promise<any>
  getCmsOperationsSummary: (...args: any[]) => Promise<any>
  getCmsOperationsDiagnostics: (...args: any[]) => Promise<any>
  getCmsOperationsHealth: (...args: any[]) => Promise<any>
  getCmsRunbooks: (...args: any[]) => Promise<any>
  getCmsPersonalizationSummary: (...args: any[]) => Promise<any>
  listCmsAudiencePersonas: (...args: any[]) => Promise<any>
  listCmsAudienceBranches: (...args: any[]) => Promise<any>
  createCmsAudienceBranch: (...args: any[]) => Promise<any>
  updateCmsAudienceBranch: (...args: any[]) => Promise<any>
  getCmsAuthorAssistance: (...args: any[]) => Promise<any>
  getCmsExtensionMarketplaceSummary: (...args: any[]) => Promise<any>
  listCmsExtensionPackages: (...args: any[]) => Promise<any>
  createCmsExtensionPackage: (...args: any[]) => Promise<any>
  updateCmsExtensionPackage: (...args: any[]) => Promise<any>
  listCmsExtensionInstallations: (...args: any[]) => Promise<any>
  installCmsExtensionPackage: (...args: any[]) => Promise<any>
  getCmsAcademicSummary: (...args: any[]) => Promise<any>
  listCmsAcademicFrameworks: (...args: any[]) => Promise<any>
  listCmsAcademicStandards: (...args: any[]) => Promise<any>
  listCmsAcademicTaxonomyAxes: (...args: any[]) => Promise<any>
  listCmsAccommodationProfiles: (...args: any[]) => Promise<any>
  listCmsDifferentiationProfiles: (...args: any[]) => Promise<any>
  getCmsCurriculumSummary: (...args: any[]) => Promise<any>
  listCmsCurriculumCourses: (...args: any[]) => Promise<any>
  getCmsCurriculumCourse: (...args: any[]) => Promise<any>
  updateCmsCurriculumCourse: (...args: any[]) => Promise<any>
  listCmsCurriculumReleaseBundles: (...args: any[]) => Promise<any>
  getCmsCurriculumReleaseBundleExportManifest: (...args: any[]) => Promise<any>
  createCmsCurriculumReleaseBundle: (...args: any[]) => Promise<any>
  getCmsAssessmentSummary: (...args: any[]) => Promise<any>
  listCmsAssessments: (...args: any[]) => Promise<any>
  getCmsAssessment: (...args: any[]) => Promise<any>
  updateCmsAssessment: (...args: any[]) => Promise<any>
  listCmsQuestionPools: (...args: any[]) => Promise<any>
  getCmsQuestionPool: (...args: any[]) => Promise<any>
  updateCmsQuestionPool: (...args: any[]) => Promise<any>
  getCmsAssessmentFormPreview: (...args: any[]) => Promise<any>
  listCmsAssessmentPackages: (...args: any[]) => Promise<any>
  getCmsAssessmentPackageExportManifest: (...args: any[]) => Promise<any>
  createCmsAssessmentPackage: (...args: any[]) => Promise<any>
  getCmsInstructionalWorkflowSummary: (...args: any[]) => Promise<any>
  listCmsInstructionalWorkflows: (...args: any[]) => Promise<any>
  getCmsInstructionalWorkflow: (...args: any[]) => Promise<any>
  getCmsReleaseSafety: (...args: any[]) => Promise<any>
  submitCmsInstructionalWorkflow: (...args: any[]) => Promise<any>
  decideCmsInstructionalWorkflowStage: (...args: any[]) => Promise<any>
  listCmsEnvironments: (...args: any[]) => Promise<any>
  listCmsWebhooks: (...args: any[]) => Promise<any>
  createCmsWebhook: (...args: any[]) => Promise<any>
  updateCmsWebhook: (...args: any[]) => Promise<any>
  listCmsPromotions: (...args: any[]) => Promise<any>
  createCmsPromotion: (...args: any[]) => Promise<any>
  listCmsBackups: (...args: any[]) => Promise<any>
  createCmsBackup: (...args: any[]) => Promise<any>
  listCmsRestores: (...args: any[]) => Promise<any>
  createCmsRestore: (...args: any[]) => Promise<any>
  listCmsExportArtifacts: (...args: any[]) => Promise<any>
  createCmsExportArtifact: (...args: any[]) => Promise<any>
  listCmsImportValidations: (...args: any[]) => Promise<any>
  createCmsImportValidation: (...args: any[]) => Promise<any>
  listCmsBenchmarkRuns: (...args: any[]) => Promise<any>
  runCmsBenchmarkSuite: (...args: any[]) => Promise<any>
  listCmsResilienceRuns: (...args: any[]) => Promise<any>
  runCmsResilienceSuite: (...args: any[]) => Promise<any>
  getCmsSecurityReview: (...args: any[]) => Promise<any>
  recordCmsSecurityReview: (...args: any[]) => Promise<any>
  getCmsReadinessReview: (...args: any[]) => Promise<any>
  recordCmsReadinessReview: (...args: any[]) => Promise<any>
  getCmsReviewSummary: (...args: any[]) => Promise<any>
  getCmsStandardsMatrix: (...args: any[]) => Promise<any>
  getCmsInteroperabilityReview: (...args: any[]) => Promise<any>
  getCmsDifferentiationReview: (...args: any[]) => Promise<any>
  getCmsFormalReviews: (...args: any[]) => Promise<any>
  recordCmsFormalReview: (...args: any[]) => Promise<any>
}

export const legacyCmsApi: LegacyCmsApi = {
    async getCmsSummary() {
