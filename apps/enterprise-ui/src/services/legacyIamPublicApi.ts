...
// Internal IAM public/protocol/account slab extracted from the legacy IAM client.
export interface LegacyIamPublicApi {
...
export const legacyIamPublicApi: LegacyIamPublicApi = {
